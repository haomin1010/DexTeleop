#!/usr/bin/env bash
# Real robot: RIGHT arm only — init B, B to start (tracker zero + 3s align), E to stop.
# Left arm:  ./scripts/run_tianji_real_teleop_left.sh
# Both arms: ./scripts/run_tianji_real_teleop_both.sh
