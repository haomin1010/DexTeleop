...
def generate_launch_description() -> LaunchDescription:
    ...
    enable_mujoco_arg = DeclareLaunchArgument(
        "enable_mujoco",
        default_value="false",
        description="Show Tianji arm joint states in a MuJoCo window",
    )
    mujoco_side_arg = DeclareLaunchArgument(
        "mujoco_side",
        default_value="right",
        description="MuJoCo viewer arm side: 'left' or 'right'",
    )
    ...
    mujoco_side = LaunchConfiguration("mujoco_side")
