...
LAUNCH_CONFIGS = {
    "Hand Only (WujiGlove+Wuji)": ["wuji_teleop_hand.launch.py", "hand_input:=wuji_glove"],
    "Arm Only (Tracker+Tianji)": ["wuji_teleop_arm.launch.py", "arm_input:=tracker"],
    "Hand+Arm Full": ["wuji_teleop.launch.py", "hand_input:=wuji_glove", "arm_input:=tracker"],
    "Hand+Arm+Camera Full": ["wuji_teleop_camera.launch.py", "hand_input:=wuji_glove", "arm_input:=tracker"],
    "Hand+Arm Single (Left)": ["wuji_teleop_single.launch.py", "side:=left", "hand_input:=wuji_glove", "arm_input:=tracker"],
    "Hand+Arm Single (Right)": ["wuji_teleop_single.launch.py", "side:=right", "hand_input:=wuji_glove", "arm_input:=tracker"],
}
